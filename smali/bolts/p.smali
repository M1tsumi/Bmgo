...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 49
    iput-object p1, p0, Lbolts/p;->a:Landroid/content/Context;

    .line 50
    return-void
.end method

.method static synthetic a(Lbolts/p;)Landroid/content/Context;
    .locals 1

    .prologue
    .line 40
    iget-object v0, p0, Lbolts/p;->a:Landroid/content/Context;
...
.method static synthetic a(Ljava/util/Map;Landroid/net/Uri;)Lbolts/b;
    .locals 1

    .prologue
    .line 40
    invoke-static {p0, p1}, Lbolts/p;->b(Ljava/util/Map;Landroid/net/Uri;)Lbolts/b;
...
.method static synthetic a(Ljava/net/URLConnection;)Ljava/lang/String;
    ...
    .prologue
    .line 40
    invoke-static {p0}, Lbolts/p;->b(Ljava/net/URLConnection;)Ljava/lang/String;
...
.method static synthetic a(Lorg/json/JSONArray;)Ljava/util/Map;
    ...
    .prologue
    .line 40
    invoke-static {p0}, Lbolts/p;->b(Lorg/json/JSONArray;)Ljava/util/Map;
...
.method private static b(Ljava/util/Map;Landroid/net/Uri;)Lbolts/b;
    .locals 13
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, v1}, Lbolts/p;->a(Ljava/util/Map;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 259
    invoke-static {v0}, Lbolts/p;->a(Ljava/lang/String;)Landroid/net/Uri;
    ...
    .line 266
    new-instance v12, Lbolts/b$a;

    invoke-direct {v12, v0, v1, v11, v2}, Lbolts/b$a;-><init>(Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;)V
    ...
    :cond_7
    :goto_6
    new-instance v1, Lbolts/b;

    invoke-direct {v1, p1, v4, v0}, Lbolts/b;-><init>(Landroid/net/Uri;Ljava/util/List;Landroid/net/Uri;)V
...
# virtual methods
.method public getAppLinkFromUrlInBackground(Landroid/net/Uri;)Lbolts/m;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 85
    new-instance v2, Lbolts/p$3;

    invoke-direct {v2, p0, p1, v0, v1}, Lbolts/p$3;-><init>(Lbolts/p;Landroid/net/Uri;Lbolts/j;Lbolts/j;)V

    invoke-static {v2}, Lbolts/m;->a(Ljava/util/concurrent/Callable;)Lbolts/m;

    move-result-object v2

    new-instance v3, Lbolts/p$2;

    invoke-direct {v3, p0, v1, p1, v0}, Lbolts/p$2;-><init>(Lbolts/p;Lbolts/j;Landroid/net/Uri;Lbolts/j;)V

    sget-object v0, Lbolts/m;->b:Ljava/util/concurrent/Executor;

    invoke-virtual {v2, v3, v0}, Lbolts/m;->d(Lbolts/k;Ljava/util/concurrent/Executor;)Lbolts/m;

    move-result-object v0

    new-instance v1, Lbolts/p$1;

    invoke-direct {v1, p0, p1}, Lbolts/p$1;-><init>(Lbolts/p;Landroid/net/Uri;)V
