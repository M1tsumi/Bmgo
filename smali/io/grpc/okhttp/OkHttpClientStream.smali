...
# static fields
.field private static final EMPTY_BUFFER:Lokio/c;

.field private static final WINDOW_UPDATE_THRESHOLD:I = 0x7fff
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/grpc/okhttp/OkHttpClientStream;->EMPTY_BUFFER:Lokio/c;
...
.method protected sendCancel(Lio/grpc/Status;)V
    ...
    .line 275
    iget-object v0, v0, Lio/grpc/okhttp/OkHttpClientStream$PendingData;->buffer:Lokio/c;
...
.method protected sendFrame(Lio/grpc/internal/WritableBuffer;ZZ)V
    ...
    .line 224
    sget-object v0, Lio/grpc/okhttp/OkHttpClientStream;->EMPTY_BUFFER:Lokio/c;
    ...
    invoke-virtual {p1}, Lio/grpc/okhttp/OkHttpWritableBuffer;->buffer()Lokio/c;
    ...
    invoke-direct {v3, v0, p2, p3}, Lio/grpc/okhttp/OkHttpClientStream$PendingData;-><init>(Lokio/c;ZZ)V
    ...
    invoke-static {v1, v3}, Lcom/google/common/base/o;->b(ZLjava/lang/Object;)V
    ...
    invoke-virtual {v1, p2, v3, v0, p3}, Lio/grpc/okhttp/OutboundFlowController;->data(ZILokio/c;Z)V
    :try_end_2
...
.method public start(Lio/grpc/internal/ClientStreamListener;)V
    ...
    iget-object v1, p0, Lio/grpc/okhttp/OkHttpClientStream;->method:Lio/grpc/MethodDescriptor;
...
.method public start(Ljava/lang/Integer;)V
    ...
    iget-object v4, p0, Lio/grpc/okhttp/OkHttpClientStream;->id:Ljava/lang/Integer;

    aput-object v4, v3, v1

    invoke-static {v0, v2, v3}, Lcom/google/common/base/o;->b(ZLjava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object v7, v0, Lio/grpc/okhttp/OkHttpClientStream$PendingData;->buffer:Lokio/c;

    invoke-virtual {v3, v4, v5, v7, v1}, Lio/grpc/okhttp/OutboundFlowController;->data(ZILokio/c;Z)V
...
.method public transportDataReceived(Lokio/c;Z)V
    .locals 4
    .annotation build Ljavax/annotation/concurrent/GuardedBy;
        value = "lock"
    .end annotation
    ...
    invoke-direct {v0, p1}, Lio/grpc/okhttp/OkHttpReadableBuffer;-><init>(Lokio/c;)V
