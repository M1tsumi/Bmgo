...
# direct methods
.method public constructor <init>(Ljava/util/concurrent/BlockingQueue;Lcom/android/volley/f;Lcom/android/volley/b;Lcom/android/volley/k;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private a(Lcom/android/volley/Request;Lcom/android/volley/VolleyError;)V
    ...
    .line 150
    iget-object v1, p0, Lcom/android/volley/g;->d:Lcom/android/volley/k;

    invoke-interface {v1, p1, v0}, Lcom/android/volley/k;->a(Lcom/android/volley/Request;Lcom/android/volley/VolleyError;)V
...
.method public run()V
    ...
    invoke-interface {v1, v0}, Lcom/android/volley/f;->a(Lcom/android/volley/Request;)Lcom/android/volley/h;
    ...
    .line 117
    iget-boolean v4, v1, Lcom/android/volley/h;->d:Z

    if-eqz v4, :cond_2

    invoke-virtual {v0}, Lcom/android/volley/Request;->y()Z
    ...
    invoke-static {v1, v4, v5}, Lcom/android/volley/m;->a(Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-interface {v1, v0, v4}, Lcom/android/volley/k;->a(Lcom/android/volley/Request;Lcom/android/volley/VolleyError;)V
    ...
    :cond_2
    :try_start_3
    invoke-virtual {v0, v1}, Lcom/android/volley/Request;->a(Lcom/android/volley/h;)Lcom/android/volley/j;
    ...
    iget-object v4, v1, Lcom/android/volley/j;->b:Lcom/android/volley/b$a;
    ...
    invoke-virtual {v0}, Lcom/android/volley/Request;->g()Ljava/lang/String;

    move-result-object v5

    iget-object v6, v1, Lcom/android/volley/j;->b:Lcom/android/volley/b$a;
    ...
    .line 134
    :cond_3
    invoke-virtual {v0}, Lcom/android/volley/Request;->x()V

    .line 135
    iget-object v4, p0, Lcom/android/volley/g;->d:Lcom/android/volley/k;

    invoke-interface {v4, v0, v1}, Lcom/android/volley/k;->a(Lcom/android/volley/Request;Lcom/android/volley/j;)V
    :try_end_3
