...
.method public a(Landroid/graphics/ColorFilter;)Landroid/graphics/Paint;
    ...
    .line 1011
    :cond_0
    iget-object v0, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$f;->m:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$f;->m:Landroid/graphics/Paint;
...
.method public b(II)V
    ...
    iput-boolean v0, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$f;->l:Z
...
.method public b()Z
    ...
    .prologue
    .line 1044
    iget-boolean v0, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$f;->l:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$f;->h:Landroid/content/res/ColorStateList;

    iget-object v1, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$f;->c:Landroid/content/res/ColorStateList;

    if-ne v0, v1, :cond_0

    iget-object v0, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$f;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    iget v0, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$f;->j:I
...
.method public c()V
    ...
    iput-object v0, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$f;->h:Landroid/content/res/ColorStateList;

    .line 1058
    iget-object v0, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$f;->d:Landroid/graphics/PorterDuff$Mode;

    iput-object v0, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$f;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    iput v0, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$f;->j:I
