...
.method constructor <init>(Landroid/support/design/internal/NavigationMenuPresenter;)V
    ...
    iput-object v0, p0, Landroid/support/design/internal/NavigationMenuPresenter$b;->h:Ljava/util/ArrayList;
...
.method private a(II)V
    ...
    .line 540
    iget-object v0, p0, Landroid/support/design/internal/NavigationMenuPresenter$b;->h:Ljava/util/ArrayList;
...
.method private c()V
    ...
    .prologue
    .line 469
    iget-boolean v0, p0, Landroid/support/design/internal/NavigationMenuPresenter$b;->j:Z
    ...
    iput-boolean v0, p0, Landroid/support/design/internal/NavigationMenuPresenter$b;->j:Z
    ...
    invoke-direct {v1}, Landroid/support/design/internal/NavigationMenuPresenter$c;-><init>()V
    ...
    .line 482
    invoke-virtual {p0, v0}, Landroid/support/design/internal/NavigationMenuPresenter$b;->a(Landroid/support/v7/view/menu/MenuItemImpl;)V
    ...
    .line 491
    iget-object v1, p0, Landroid/support/design/internal/NavigationMenuPresenter$b;->h:Ljava/util/ArrayList;
    ...
    iget v6, v6, Landroid/support/design/internal/NavigationMenuPresenter;->j:I
    ...
    invoke-direct {v2, v0}, Landroid/support/design/internal/NavigationMenuPresenter$f;-><init>(Landroid/support/v7/view/menu/MenuItemImpl;)V
    ...
    .line 508
    :cond_6
    iget-object v12, p0, Landroid/support/design/internal/NavigationMenuPresenter$b;->h:Ljava/util/ArrayList;

    new-instance v13, Landroid/support/design/internal/NavigationMenuPresenter$f;

    invoke-direct {v13, v1}, Landroid/support/design/internal/NavigationMenuPresenter$f;-><init>(Landroid/support/v7/view/menu/MenuItemImpl;)V
    ...
    invoke-direct {p0, v10, v0}, Landroid/support/design/internal/NavigationMenuPresenter$b;->a(II)V
    ...
    .line 522
    iget-object v3, p0, Landroid/support/design/internal/NavigationMenuPresenter$b;->h:Ljava/util/ArrayList;
    ...
    iget v5, v5, Landroid/support/design/internal/NavigationMenuPresenter;->j:I
    ...
    iget v9, v9, Landroid/support/design/internal/NavigationMenuPresenter;->j:I

    invoke-direct {v4, v5, v9}, Landroid/support/design/internal/NavigationMenuPresenter$e;-><init>(II)V
    ...
    :cond_b
    :goto_5
    new-instance v3, Landroid/support/design/internal/NavigationMenuPresenter$f;

    invoke-direct {v3, v0}, Landroid/support/design/internal/NavigationMenuPresenter$f;-><init>(Landroid/support/v7/view/menu/MenuItemImpl;)V

    .line 530
    iput-boolean v1, v3, Landroid/support/design/internal/NavigationMenuPresenter$f;->a:Z
    ...
    .line 527
    iget-object v2, p0, Landroid/support/design/internal/NavigationMenuPresenter$b;->h:Ljava/util/ArrayList;

    invoke-virtual {v2}, Ljava/util/ArrayList;->size()I

    move-result v2

    invoke-direct {p0, v4, v2}, Landroid/support/design/internal/NavigationMenuPresenter$b;->a(II)V
...
.method public a(Landroid/view/ViewGroup;I)Landroid/support/design/internal/NavigationMenuPresenter$j;
    ...
    iget-object v1, v1, Landroid/support/design/internal/NavigationMenuPresenter;->d:Landroid/view/LayoutInflater;
    ...
    iget-object v2, v2, Landroid/support/design/internal/NavigationMenuPresenter;->k:Landroid/view/View$OnClickListener;
    ...
    iget-object v1, v1, Landroid/support/design/internal/NavigationMenuPresenter;->a:Landroid/widget/LinearLayout;
...
.method public a()V
    ...
    .line 461
    invoke-virtual {p0}, Landroid/support/design/internal/NavigationMenuPresenter$b;->notifyDataSetChanged()V
...
.method public a(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0}, Landroid/support/design/internal/NavigationMenuPresenter$f;->a()Landroid/support/v7/view/menu/MenuItemImpl;
    ...
    .line 593
    :cond_0
    iput-boolean v1, p0, Landroid/support/design/internal/NavigationMenuPresenter$b;->j:Z
...
.method public a(Landroid/support/design/internal/NavigationMenuPresenter$j;)V
    ...
    .line 455
    iget-object v0, p1, Landroid/support/design/internal/NavigationMenuPresenter$j;->itemView:Landroid/view/View;
...
.method public a(Landroid/support/design/internal/NavigationMenuPresenter$j;I)V
    ...
    .line 415
    invoke-virtual {p0, p2}, Landroid/support/design/internal/NavigationMenuPresenter$b;->getItemViewType(I)I
    ...
    iget-object v1, v1, Landroid/support/design/internal/NavigationMenuPresenter;->h:Landroid/content/res/ColorStateList;
    ...
    iget-boolean v1, v1, Landroid/support/design/internal/NavigationMenuPresenter;->f:Z
    ...
    iget v1, v1, Landroid/support/design/internal/NavigationMenuPresenter;->e:I
    ...
    iget-object v1, v1, Landroid/support/design/internal/NavigationMenuPresenter;->g:Landroid/content/res/ColorStateList;
    ...
    iget-object v1, v1, Landroid/support/design/internal/NavigationMenuPresenter;->i:Landroid/graphics/drawable/Drawable;
    ...
    .line 428
    iget-boolean v2, v1, Landroid/support/design/internal/NavigationMenuPresenter$f;->a:Z

    invoke-virtual {v0, v2}, Landroid/support/design/internal/NavigationMenuItemView;->setNeedsEmptyIcon(Z)V

    .line 429
    invoke-virtual {v1}, Landroid/support/design/internal/NavigationMenuPresenter$f;->a()Landroid/support/v7/view/menu/MenuItemImpl;
    ...
    .line 441
    iget-object v1, p1, Landroid/support/design/internal/NavigationMenuPresenter$j;->itemView:Landroid/view/View;
...
.method public a(Landroid/support/v7/view/menu/MenuItemImpl;)V
    ...
    .prologue
    .line 546
    iget-object v0, p0, Landroid/support/design/internal/NavigationMenuPresenter$b;->i:Landroid/support/v7/view/menu/MenuItemImpl;
    ...
    .line 552
    :cond_2
    iput-object p1, p0, Landroid/support/design/internal/NavigationMenuPresenter$b;->i:Landroid/support/v7/view/menu/MenuItemImpl;
...
.method public a(Z)V
    ...
    .prologue
    .line 623
    iput-boolean p1, p0, Landroid/support/design/internal/NavigationMenuPresenter$b;->j:Z
...
.method public b()Landroid/os/Bundle;
    ...
    iget-object v1, p0, Landroid/support/design/internal/NavigationMenuPresenter$b;->i:Landroid/support/v7/view/menu/MenuItemImpl;
