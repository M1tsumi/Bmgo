...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/support/design/widget/BaseTransientBottomBar$g;,
...
# instance fields
.field final i:Landroid/support/design/widget/BaseTransientBottomBar$g;
...
.field private final m:Landroid/support/design/widget/BaseTransientBottomBar$c;
...
.method protected constructor <init>(Landroid/view/ViewGroup;Landroid/view/View;Landroid/support/design/widget/BaseTransientBottomBar$c;)V
    ...
    .line 234
    :cond_2
    iput-object p1, p0, Landroid/support/design/widget/BaseTransientBottomBar;->k:Landroid/view/ViewGroup;

    .line 235
    iput-object p3, p0, Landroid/support/design/widget/BaseTransientBottomBar;->m:Landroid/support/design/widget/BaseTransientBottomBar$c;
    ...
    iput-object v0, p0, Landroid/support/design/widget/BaseTransientBottomBar;->l:Landroid/content/Context;

    .line 238
    iget-object v0, p0, Landroid/support/design/widget/BaseTransientBottomBar;->l:Landroid/content/Context;
    ...
    .line 244
    sget v1, Ld/b$j;->design_layout_snackbar:I

    iget-object v2, p0, Landroid/support/design/widget/BaseTransientBottomBar;->k:Landroid/view/ViewGroup;
    ...
    check-cast v0, Landroid/support/design/widget/BaseTransientBottomBar$g;

    iput-object v0, p0, Landroid/support/design/widget/BaseTransientBottomBar;->i:Landroid/support/design/widget/BaseTransientBottomBar$g;

    .line 246
    iget-object v0, p0, Landroid/support/design/widget/BaseTransientBottomBar;->i:Landroid/support/design/widget/BaseTransientBottomBar$g;

    invoke-virtual {v0, p2}, Landroid/support/design/widget/BaseTransientBottomBar$g;->addView(Landroid/view/View;)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/BaseTransientBottomBar;->p:Landroid/view/accessibility/AccessibilityManager;
...
.method static synthetic a(Landroid/support/design/widget/BaseTransientBottomBar;)Landroid/support/design/widget/BaseTransientBottomBar$c;
    ...
    .prologue
    .line 59
    iget-object v0, p0, Landroid/support/design/widget/BaseTransientBottomBar;->m:Landroid/support/design/widget/BaseTransientBottomBar$c;
...
.method private e(I)V
    ...
    iget-object v1, p0, Landroid/support/design/widget/BaseTransientBottomBar;->i:Landroid/support/design/widget/BaseTransientBottomBar$g;

    .line 532
    invoke-virtual {v1}, Landroid/support/design/widget/BaseTransientBottomBar$g;->getHeight()I
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/BaseTransientBottomBar$g;->getContext()Landroid/content/Context;

    move-result-object v0

    sget v1, Ld/b$a;->design_snackbar_out:I
    ...
    invoke-virtual {v1, v0}, Landroid/support/design/widget/BaseTransientBottomBar$g;->startAnimation(Landroid/view/animation/Animation;)V
...
.method public a()I
    ...
    .prologue
    .line 292
    iget v0, p0, Landroid/support/design/widget/BaseTransientBottomBar;->n:I
...
.method public a(I)Landroid/support/design/widget/BaseTransientBottomBar;
    ...
    .prologue
    .line 281
    iput p1, p0, Landroid/support/design/widget/BaseTransientBottomBar;->n:I

    .line 282
    return-object p0
.end method

.method public addCallback(Landroid/support/design/widget/BaseTransientBottomBar$a;)Landroid/support/design/widget/BaseTransientBottomBar;
    .locals 1
    ...
    .line 341
    :cond_0
    iget-object v0, p0, Landroid/support/design/widget/BaseTransientBottomBar;->o:Ljava/util/List;
    ...
    iput-object v0, p0, Landroid/support/design/widget/BaseTransientBottomBar;->o:Ljava/util/List;
...
.method final c(I)V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/BaseTransientBottomBar$g;->getVisibility()I
...
.method public d()V
    ...
    iget v1, p0, Landroid/support/design/widget/BaseTransientBottomBar;->n:I
...
.method d(I)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/widget/BaseTransientBottomBar$g;->setVisibility(I)V

    .line 608
    :cond_1
    iget-object v0, p0, Landroid/support/design/widget/BaseTransientBottomBar;->i:Landroid/support/design/widget/BaseTransientBottomBar$g;

    invoke-virtual {v0}, Landroid/support/design/widget/BaseTransientBottomBar$g;->getParent()Landroid/view/ViewParent;
...
.method final h()V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/BaseTransientBottomBar$g;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 436
    :cond_0
    iget-object v0, p0, Landroid/support/design/widget/BaseTransientBottomBar;->k:Landroid/view/ViewGroup;
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/widget/BaseTransientBottomBar$g;->setOnAttachStateChangeListener(Landroid/support/design/widget/BaseTransientBottomBar$e;)V
...
.method i()V
    ...
    sget v1, Ld/b$a;->design_snackbar_in:I
...
.method k()Z
    ...
    .prologue
    .line 618
    iget-object v0, p0, Landroid/support/design/widget/BaseTransientBottomBar;->p:Landroid/view/accessibility/AccessibilityManager;
...
.method public removeCallback(Landroid/support/design/widget/BaseTransientBottomBar$a;)Landroid/support/design/widget/BaseTransientBottomBar;
    .locals 1
    .param p1    # Landroid/support/design/widget/BaseTransientBottomBar$a;
        .annotation build Landroid/support/annotation/z;
        .end annotation
