...
.method constructor <init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/m;Landroid/support/design/widget/q$d;)V
    ...
    .prologue
    .line 44
    invoke-direct {p0, p1, p2, p3}, Landroid/support/design/widget/h;-><init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/m;Landroid/support/design/widget/q$d;)V
...
.method a(FF)V
    ...
    .line 144
    :goto_0
    iget-object v0, p0, Landroid/support/design/widget/j;->u:Landroid/support/design/widget/m;
    ...
    .line 105
    iget-object v2, p0, Landroid/support/design/widget/j;->t:Landroid/support/design/widget/VisibilityAwareImageButton;
    ...
    iget-object v3, p0, Landroid/support/design/widget/j;->t:Landroid/support/design/widget/VisibilityAwareImageButton;
    ...
    .line 109
    sget-object v2, Landroid/support/design/widget/j;->p:[I
    ...
    .line 117
    sget-object v2, Landroid/support/design/widget/j;->q:[I
    ...
    iget-object v4, p0, Landroid/support/design/widget/j;->t:Landroid/support/design/widget/VisibilityAwareImageButton;
    ...
    iget-object v8, p0, Landroid/support/design/widget/j;->t:Landroid/support/design/widget/VisibilityAwareImageButton;
    ...
    .line 132
    sget-object v2, Landroid/support/design/widget/j;->r:[I
    ...
    .line 139
    sget-object v2, Landroid/support/design/widget/j;->s:[I
...
.method a(I)V
    ...
    .prologue
    .line 76
    iget-object v0, p0, Landroid/support/design/widget/j;->j:Landroid/graphics/drawable/Drawable;
...
.method a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;II)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/j;->k:Landroid/support/design/widget/b;
    ...
    iget-object v3, p0, Landroid/support/design/widget/j;->k:Landroid/support/design/widget/b;

    aput-object v3, v1, v2

    const/4 v2, 0x1

    iget-object v3, p0, Landroid/support/design/widget/j;->i:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v1, p0, Landroid/support/design/widget/j;->j:Landroid/graphics/drawable/Drawable;

    .line 69
    iget-object v0, p0, Landroid/support/design/widget/j;->j:Landroid/graphics/drawable/Drawable;

    iput-object v0, p0, Landroid/support/design/widget/j;->l:Landroid/graphics/drawable/Drawable;

    .line 71
    iget-object v0, p0, Landroid/support/design/widget/j;->u:Landroid/support/design/widget/m;

    iget-object v1, p0, Landroid/support/design/widget/j;->j:Landroid/graphics/drawable/Drawable;
    ...
    .line 62
    :cond_1
    iput-object v4, p0, Landroid/support/design/widget/j;->k:Landroid/support/design/widget/b;
...
.method a(Landroid/graphics/Rect;)V
    ...
    iget v2, p0, Landroid/support/design/widget/j;->n:F
...
.method b(Landroid/graphics/Rect;)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/j;->w:Landroid/graphics/drawable/InsetDrawable;

    .line 164
    iget-object v0, p0, Landroid/support/design/widget/j;->u:Landroid/support/design/widget/m;

    iget-object v1, p0, Landroid/support/design/widget/j;->w:Landroid/graphics/drawable/InsetDrawable;
