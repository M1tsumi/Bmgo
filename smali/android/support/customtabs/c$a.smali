...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0}, Landroid/support/customtabs/c$a;-><init>(Landroid/support/customtabs/e;)V

    .line 286
    return-void
.end method

.method public constructor <init>(Landroid/support/customtabs/e;)V
    .locals 3
    .param p1    # Landroid/support/customtabs/e;
    ...
    iput-object v1, p0, Landroid/support/customtabs/c$a;->a:Landroid/content/Intent;
    ...
    invoke-virtual {p1}, Landroid/support/customtabs/e;->b()Landroid/content/ComponentName;
    ...
    .line 301
    :cond_1
    invoke-virtual {p1}, Landroid/support/customtabs/e;->a()Landroid/os/IBinder;
...
# virtual methods
.method public a()Landroid/support/customtabs/c$a;
    .locals 3
...
.method public a(I)Landroid/support/customtabs/c$a;
    .locals 2
    .param p1    # I
...
.method public a(ILandroid/graphics/Bitmap;Ljava/lang/String;Landroid/app/PendingIntent;)Landroid/support/customtabs/c$a;
    .locals 2
    ...
    .line 437
    iget-object v1, p0, Landroid/support/customtabs/c$a;->d:Ljava/util/ArrayList;
...
.method public a(Landroid/content/Context;II)Landroid/support/customtabs/c$a;
    .locals 1
...
.method public a(Landroid/graphics/Bitmap;)Landroid/support/customtabs/c$a;
    .locals 2
...
.method public a(Landroid/graphics/Bitmap;Ljava/lang/String;Landroid/app/PendingIntent;)Landroid/support/customtabs/c$a;
    .locals 1
    .param p1    # Landroid/graphics/Bitmap;
        .annotation build Landroid/support/annotation/z;
        .end annotation
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Landroid/support/customtabs/c$a;->a(Landroid/graphics/Bitmap;Ljava/lang/String;Landroid/app/PendingIntent;Z)Landroid/support/customtabs/c$a;
...
.method public a(Landroid/graphics/Bitmap;Ljava/lang/String;Landroid/app/PendingIntent;Z)Landroid/support/customtabs/c$a;
    .locals 3
    .param p1    # Landroid/graphics/Bitmap;
        .annotation build Landroid/support/annotation/z;
        .end annotation
...
.method public a(Landroid/widget/RemoteViews;[ILandroid/app/PendingIntent;)Landroid/support/customtabs/c$a;
    .locals 2
...
.method public a(Ljava/lang/String;Landroid/app/PendingIntent;)Landroid/support/customtabs/c$a;
    .locals 2
    ...
    .line 355
    iget-object v1, p0, Landroid/support/customtabs/c$a;->b:Ljava/util/ArrayList;
...
.method public a(Z)Landroid/support/customtabs/c$a;
    .locals 3
...
.method public b()Landroid/support/customtabs/c$a;
    .locals 3
...
.method public b(I)Landroid/support/customtabs/c$a;
    .locals 2
    .param p1    # I
        .annotation build Landroid/support/annotation/k;
        .end annotation
...
.method public b(Landroid/content/Context;II)Landroid/support/customtabs/c$a;
    .locals 3
    .param p1    # Landroid/content/Context;
        .annotation build Landroid/support/annotation/z;
        .end annotation
...
.method public b(Z)Landroid/support/customtabs/c$a;
    .locals 0

    .prologue
    .line 479
    iput-boolean p1, p0, Landroid/support/customtabs/c$a;->e:Z
...
.method public c()Landroid/support/customtabs/c;
    ...
    iget-object v2, p0, Landroid/support/customtabs/c$a;->b:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Landroid/support/customtabs/c$a;->d:Ljava/util/ArrayList;
    ...
    iget-boolean v2, p0, Landroid/support/customtabs/c$a;->e:Z
    ...
    invoke-direct {v0, v1, v2, v3}, Landroid/support/customtabs/c;-><init>(Landroid/content/Intent;Landroid/os/Bundle;Landroid/support/customtabs/c$1;)V
