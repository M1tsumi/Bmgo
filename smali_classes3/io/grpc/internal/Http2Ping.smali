...
.field private final stopwatch:Lcom/google/common/base/s;
...
.method public constructor <init>(JLcom/google/common/base/s;)V
    .locals 1
    ...
    .line 100
    iput-object p3, p0, Lio/grpc/internal/Http2Ping;->stopwatch:Lcom/google/common/base/s;
...
.method public complete()Z
    ...
    .line 148
    iget-object v0, p0, Lio/grpc/internal/Http2Ping;->stopwatch:Lcom/google/common/base/s;
    ...
    iput-wide v4, p0, Lio/grpc/internal/Http2Ping;->roundTripTimeNanos:J
    ...
    check-cast v0, Lio/grpc/internal/ClientTransport$PingCallback;

    invoke-static {v0, v4, v5}, Lio/grpc/internal/Http2Ping;->asRunnable(Lio/grpc/internal/ClientTransport$PingCallback;J)Ljava/lang/Runnable;

    move-result-object v0

    invoke-static {v1, v0}, Lio/grpc/internal/Http2Ping;->doExecute(Ljava/util/concurrent/Executor;Ljava/lang/Runnable;)V
...
.method public failed(Ljava/lang/Throwable;)V
    ...
    invoke-static {v0, p1}, Lio/grpc/internal/Http2Ping;->asRunnable(Lio/grpc/internal/ClientTransport$PingCallback;Ljava/lang/Throwable;)Ljava/lang/Runnable;
