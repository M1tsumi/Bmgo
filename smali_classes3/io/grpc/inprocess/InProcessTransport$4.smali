...
.method constructor <init>(Lio/grpc/inprocess/InProcessTransport;Lio/grpc/internal/ClientTransport$PingCallback;Lio/grpc/Status;)V
    ...
    iput-object p2, p0, Lio/grpc/inprocess/InProcessTransport$4;->val$callback:Lio/grpc/internal/ClientTransport$PingCallback;

    iput-object p3, p0, Lio/grpc/inprocess/InProcessTransport$4;->val$shutdownStatus:Lio/grpc/Status;
...
.method public run()V
    ...
    .prologue
    .line 158
    iget-object v0, p0, Lio/grpc/inprocess/InProcessTransport$4;->val$callback:Lio/grpc/internal/ClientTransport$PingCallback;

    iget-object v1, p0, Lio/grpc/inprocess/InProcessTransport$4;->val$shutdownStatus:Lio/grpc/Status;
