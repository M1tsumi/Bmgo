.class public Lio/rong/eventbus/util/ErrorDialogManager;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lio/rong/eventbus/util/ErrorDialogManager$HoneycombManagerFragment;,
        Lio/rong/eventbus/util/ErrorDialogManager$SupportManagerFragment;
    }
.end annotation
...
.field public static factory:Lio/rong/eventbus/util/ErrorDialogFragmentFactory;
...
.method static synthetic access$000(Ljava/lang/Object;Lio/rong/eventbus/util/ThrowableFailureEvent;)Z
    .locals 1

    .prologue
    .line 29
    invoke-static {p0, p1}, Lio/rong/eventbus/util/ErrorDialogManager;->isInExecutionScope(Ljava/lang/Object;Lio/rong/eventbus/util/ThrowableFailureEvent;)Z
...
.method public static attachTo(Landroid/app/Activity;)V
    ...
    invoke-static {p0, v0, v1}, Lio/rong/eventbus/util/ErrorDialogManager;->attachTo(Landroid/app/Activity;ZLandroid/os/Bundle;)V
...
.method public static attachTo(Landroid/app/Activity;Ljava/lang/Object;ZLandroid/os/Bundle;)V
    ...
    .line 192
    :cond_0
    invoke-static {p0}, Lio/rong/eventbus/util/ErrorDialogManager;->isSupportActivity(Landroid/app/Activity;)Z
    ...
    .line 193
    invoke-static {p0, p1, p2, p3}, Lio/rong/eventbus/util/ErrorDialogManager$SupportManagerFragment;->attachTo(Landroid/app/Activity;Ljava/lang/Object;ZLandroid/os/Bundle;)V
    ...
    .line 195
    :cond_1
    invoke-static {p0, p1, p2, p3}, Lio/rong/eventbus/util/ErrorDialogManager$HoneycombManagerFragment;->attachTo(Landroid/app/Activity;Ljava/lang/Object;ZLandroid/os/Bundle;)V
...
.method public static attachTo(Landroid/app/Activity;Z)V
    ...
    invoke-static {p0, p1, v0}, Lio/rong/eventbus/util/ErrorDialogManager;->attachTo(Landroid/app/Activity;ZLandroid/os/Bundle;)V
...
.method public static attachTo(Landroid/app/Activity;ZLandroid/os/Bundle;)V
    ...
    .line 185
    invoke-static {p0, v0, p1, p2}, Lio/rong/eventbus/util/ErrorDialogManager;->attachTo(Landroid/app/Activity;Ljava/lang/Object;ZLandroid/os/Bundle;)V

    .line 186
    return-void
.end method

.method protected static checkLogException(Lio/rong/eventbus/util/ThrowableFailureEvent;)V
    .locals 3
    ...
    iget-boolean v0, v0, Lio/rong/eventbus/util/ErrorDialogConfig;->logExceptions:Z
    ...
    iget-object v0, v0, Lio/rong/eventbus/util/ErrorDialogConfig;->tagForLoggingExceptions:Ljava/lang/String;
    ...
    iget-object v2, p0, Lio/rong/eventbus/util/ThrowableFailureEvent;->throwable:Ljava/lang/Throwable;
...
.method private static isInExecutionScope(Ljava/lang/Object;Lio/rong/eventbus/util/ThrowableFailureEvent;)Z
    .locals 1
    ...
    .line 236
    invoke-virtual {p1}, Lio/rong/eventbus/util/ThrowableFailureEvent;->getExecutionScope()Ljava/lang/Object;
