...
.field private final e:Lio/fabric/sdk/android/services/common/j;
...
.method public constructor <init>(Lio/fabric/sdk/android/h;Lio/fabric/sdk/android/services/settings/w;Lio/fabric/sdk/android/services/common/j;Lio/fabric/sdk/android/services/settings/v;Lio/fabric/sdk/android/services/settings/h;Lio/fabric/sdk/android/services/settings/x;)V
    ...
    .line 54
    iput-object p1, p0, Lio/fabric/sdk/android/services/settings/k;->h:Lio/fabric/sdk/android/h;

    .line 55
    iput-object p2, p0, Lio/fabric/sdk/android/services/settings/k;->c:Lio/fabric/sdk/android/services/settings/w;

    .line 56
    iput-object p3, p0, Lio/fabric/sdk/android/services/settings/k;->e:Lio/fabric/sdk/android/services/common/j;
    ...
    iget-object v1, p0, Lio/fabric/sdk/android/services/settings/k;->h:Lio/fabric/sdk/android/h;

    invoke-direct {v0, v1}, Ldy/e;-><init>(Lio/fabric/sdk/android/h;)V

    iput-object v0, p0, Lio/fabric/sdk/android/services/settings/k;->i:Ldy/d;
...
.method private b(Lio/fabric/sdk/android/services/settings/SettingsCacheBehavior;)Lio/fabric/sdk/android/services/settings/t;
    ...
    .line 109
    iget-object v1, p0, Lio/fabric/sdk/android/services/settings/k;->f:Lio/fabric/sdk/android/services/settings/h;

    invoke-interface {v1}, Lio/fabric/sdk/android/services/settings/h;->a()Lorg/json/JSONObject;
    ...
    .line 112
    iget-object v1, p0, Lio/fabric/sdk/android/services/settings/k;->d:Lio/fabric/sdk/android/services/settings/v;

    iget-object v3, p0, Lio/fabric/sdk/android/services/settings/k;->e:Lio/fabric/sdk/android/services/common/j;

    invoke-interface {v1, v3, v2}, Lio/fabric/sdk/android/services/settings/v;->a(Lio/fabric/sdk/android/services/common/j;Lorg/json/JSONObject;)Lio/fabric/sdk/android/services/settings/t;
    ...
    invoke-direct {p0, v2, v3}, Lio/fabric/sdk/android/services/settings/k;->a(Lorg/json/JSONObject;Ljava/lang/String;)V

    .line 118
    iget-object v2, p0, Lio/fabric/sdk/android/services/settings/k;->e:Lio/fabric/sdk/android/services/common/j;
    ...
    invoke-virtual {v1, v2, v3}, Lio/fabric/sdk/android/services/settings/t;->a(J)Z
    :try_end_0
...
.method public a(Lio/fabric/sdk/android/services/settings/SettingsCacheBehavior;)Lio/fabric/sdk/android/services/settings/t;
    ...
    .line 75
    :try_start_0
    invoke-static {}, Lio/fabric/sdk/android/Fabric;->j()Z
    ...
    .line 80
    :try_start_1
    iget-object v0, p0, Lio/fabric/sdk/android/services/settings/k;->g:Lio/fabric/sdk/android/services/settings/x;

    iget-object v2, p0, Lio/fabric/sdk/android/services/settings/k;->c:Lio/fabric/sdk/android/services/settings/w;

    invoke-interface {v0, v2}, Lio/fabric/sdk/android/services/settings/x;->a(Lio/fabric/sdk/android/services/settings/w;)Lorg/json/JSONObject;
    ...
    .line 83
    iget-object v2, p0, Lio/fabric/sdk/android/services/settings/k;->d:Lio/fabric/sdk/android/services/settings/v;

    iget-object v3, p0, Lio/fabric/sdk/android/services/settings/k;->e:Lio/fabric/sdk/android/services/common/j;

    invoke-interface {v2, v3, v0}, Lio/fabric/sdk/android/services/settings/v;->a(Lio/fabric/sdk/android/services/common/j;Lorg/json/JSONObject;)Lio/fabric/sdk/android/services/settings/t;

    move-result-object v1

    .line 85
    iget-object v2, p0, Lio/fabric/sdk/android/services/settings/k;->f:Lio/fabric/sdk/android/services/settings/h;

    iget-wide v4, v1, Lio/fabric/sdk/android/services/settings/t;->g:J

    invoke-interface {v2, v4, v5, v0}, Lio/fabric/sdk/android/services/settings/h;->a(JLorg/json/JSONObject;)V

    .line 86
    const-string v2, "Loaded settings: "

    invoke-direct {p0, v0, v2}, Lio/fabric/sdk/android/services/settings/k;->a(Lorg/json/JSONObject;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lio/fabric/sdk/android/services/settings/k;->a(Ljava/lang/String;)Z
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_1
    ...
    invoke-direct {p0, v1}, Lio/fabric/sdk/android/services/settings/k;->b(Lio/fabric/sdk/android/services/settings/SettingsCacheBehavior;)Lio/fabric/sdk/android/services/settings/t;
    :try_end_2
...
.method a(Ljava/lang/String;)Z
    ...
    .prologue
    .line 157
    iget-object v0, p0, Lio/fabric/sdk/android/services/settings/k;->i:Ldy/d;
    ...
    .line 159
    iget-object v1, p0, Lio/fabric/sdk/android/services/settings/k;->i:Ldy/d;

    invoke-interface {v1, v0}, Ldy/d;->a(Landroid/content/SharedPreferences$Editor;)Z
...
.method b()Ljava/lang/String;
    ...
    iget-object v2, p0, Lio/fabric/sdk/android/services/settings/k;->h:Lio/fabric/sdk/android/h;
