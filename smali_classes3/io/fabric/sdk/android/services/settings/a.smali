...
# static fields
.field public static final A:Ljava/lang/String; = "app[build][libraries][%s]"

.field public static final B:Ljava/lang/String; = "app[build][libraries][%s][version]"

.field public static final C:Ljava/lang/String; = "app[build][libraries][%s][type]"

.field static final D:Ljava/lang/String; = "icon.png"

.field static final E:Ljava/lang/String; = "application/octet-stream"

.field public static final n:Ljava/lang/String; = "app[identifier]"

.field public static final o:Ljava/lang/String; = "app[name]"

.field public static final p:Ljava/lang/String; = "app[instance_identifier]"

.field public static final q:Ljava/lang/String; = "app[display_version]"

.field public static final r:Ljava/lang/String; = "app[build_version]"

.field public static final s:Ljava/lang/String; = "app[source]"

.field public static final t:Ljava/lang/String; = "app[minimum_sdk_version]"

.field public static final u:Ljava/lang/String; = "app[built_sdk_version]"

.field public static final v:Ljava/lang/String; = "app[icon][hash]"

.field public static final w:Ljava/lang/String; = "app[icon][data]"

.field public static final x:Ljava/lang/String; = "app[icon][width]"

.field public static final y:Ljava/lang/String; = "app[icon][height]"

.field public static final z:Ljava/lang/String; = "app[icon][prerendered]"
...
.method private a(Lio/fabric/sdk/android/services/network/HttpRequest;Lio/fabric/sdk/android/services/settings/d;)Lio/fabric/sdk/android/services/network/HttpRequest;
    ...
    iget-object v2, p0, Lio/fabric/sdk/android/services/settings/a;->m:Lio/fabric/sdk/android/h;

    invoke-virtual {v2}, Lio/fabric/sdk/android/h;->getVersion()Ljava/lang/String;
...
.method private b(Lio/fabric/sdk/android/services/network/HttpRequest;Lio/fabric/sdk/android/services/settings/d;)Lio/fabric/sdk/android/services/network/HttpRequest;
    ...
    invoke-virtual {p1, v0, v1}, Lio/fabric/sdk/android/services/network/HttpRequest;->h(Ljava/lang/String;Ljava/lang/String;)Lio/fabric/sdk/android/services/network/HttpRequest;
    ...
    invoke-virtual {v0, v1, v2}, Lio/fabric/sdk/android/services/network/HttpRequest;->h(Ljava/lang/String;Ljava/lang/String;)Lio/fabric/sdk/android/services/network/HttpRequest;
    ...
    invoke-virtual {v0, v1, v2}, Lio/fabric/sdk/android/services/network/HttpRequest;->b(Ljava/lang/String;Ljava/lang/Number;)Lio/fabric/sdk/android/services/network/HttpRequest;
    ...
    invoke-static {v0}, Lio/fabric/sdk/android/services/common/CommonUtils;->e(Ljava/lang/String;)Z
    ...
    invoke-virtual {v2, v0, v1}, Lio/fabric/sdk/android/services/network/HttpRequest;->h(Ljava/lang/String;Ljava/lang/String;)Lio/fabric/sdk/android/services/network/HttpRequest;

    .line 120
    :cond_0
    iget-object v0, p2, Lio/fabric/sdk/android/services/settings/d;->j:Lio/fabric/sdk/android/services/settings/o;
    ...
    .line 124
    :try_start_0
    iget-object v0, p0, Lio/fabric/sdk/android/services/settings/a;->m:Lio/fabric/sdk/android/h;
    ...
    invoke-virtual {v2, v0, v3}, Lio/fabric/sdk/android/services/network/HttpRequest;->h(Ljava/lang/String;Ljava/lang/String;)Lio/fabric/sdk/android/services/network/HttpRequest;
    ...
    invoke-virtual {v0, v3, v4}, Lio/fabric/sdk/android/services/network/HttpRequest;->b(Ljava/lang/String;Ljava/lang/Number;)Lio/fabric/sdk/android/services/network/HttpRequest;
    ...
    iget v4, v4, Lio/fabric/sdk/android/services/settings/o;->d:I
    ...
    invoke-virtual {v2, v3, v4}, Lio/fabric/sdk/android/services/network/HttpRequest;->h(Ljava/lang/String;Ljava/lang/String;)Lio/fabric/sdk/android/services/network/HttpRequest;
    ...
    invoke-virtual {v2, v3, v0}, Lio/fabric/sdk/android/services/network/HttpRequest;->h(Ljava/lang/String;Ljava/lang/String;)Lio/fabric/sdk/android/services/network/HttpRequest;
...
.method public a(Lio/fabric/sdk/android/services/settings/d;)Z
    ...
    .line 79
    iget-object v0, p1, Lio/fabric/sdk/android/services/settings/d;->j:Lio/fabric/sdk/android/services/settings/o;
    ...
    .line 86
    :cond_0
    invoke-virtual {v1}, Lio/fabric/sdk/android/services/network/HttpRequest;->c()I
    ...
    invoke-virtual {v1, v5}, Lio/fabric/sdk/android/services/network/HttpRequest;->e(Ljava/lang/String;)Ljava/lang/String;
