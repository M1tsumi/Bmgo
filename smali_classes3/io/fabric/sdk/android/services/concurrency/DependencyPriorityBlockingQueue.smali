...
# virtual methods
.method canProcess(Lio/fabric/sdk/android/services/concurrency/b;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TE;)Z"
    ...
    .prologue
    .line 248
    invoke-interface {p1}, Lio/fabric/sdk/android/services/concurrency/b;->e()Z
...
.method get(ILjava/lang/Long;Ljava/util/concurrent/TimeUnit;)Lio/fabric/sdk/android/services/concurrency/b;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
    ...
    .line 236
    :goto_0
    invoke-virtual {p0, p1, p2, p3}, Lio/fabric/sdk/android/services/concurrency/DependencyPriorityBlockingQueue;->performOperation(ILjava/lang/Long;Ljava/util/concurrent/TimeUnit;)Lio/fabric/sdk/android/services/concurrency/b;
    ...
    .line 237
    invoke-virtual {p0, v0}, Lio/fabric/sdk/android/services/concurrency/DependencyPriorityBlockingQueue;->canProcess(Lio/fabric/sdk/android/services/concurrency/b;)Z
    ...
    .line 240
    :cond_1
    invoke-virtual {p0, p1, v0}, Lio/fabric/sdk/android/services/concurrency/DependencyPriorityBlockingQueue;->offerBlockedResult(ILio/fabric/sdk/android/services/concurrency/b;)Z

    goto :goto_0
.end method

.method offerBlockedResult(ILio/fabric/sdk/android/services/concurrency/b;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ITE;)Z"
...
.method public peek()Lio/fabric/sdk/android/services/concurrency/b;
    ...
    :try_start_0
    invoke-virtual {p0, v1, v2, v3}, Lio/fabric/sdk/android/services/concurrency/DependencyPriorityBlockingQueue;->get(ILjava/lang/Long;Ljava/util/concurrent/TimeUnit;)Lio/fabric/sdk/android/services/concurrency/b;
    :try_end_0
...
.method performOperation(ILjava/lang/Long;Ljava/util/concurrent/TimeUnit;)Lio/fabric/sdk/android/services/concurrency/b;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
...
.method public poll(JLjava/util/concurrent/TimeUnit;)Lio/fabric/sdk/android/services/concurrency/b;
    ...
    invoke-virtual {p0, v0, v1, p3}, Lio/fabric/sdk/android/services/concurrency/DependencyPriorityBlockingQueue;->get(ILjava/lang/Long;Ljava/util/concurrent/TimeUnit;)Lio/fabric/sdk/android/services/concurrency/b;
...
.method public take()Lio/fabric/sdk/android/services/concurrency/b;
    ...
    invoke-virtual {p0, v0, v1, v1}, Lio/fabric/sdk/android/services/concurrency/DependencyPriorityBlockingQueue;->get(ILjava/lang/Long;Ljava/util/concurrent/TimeUnit;)Lio/fabric/sdk/android/services/concurrency/b;
