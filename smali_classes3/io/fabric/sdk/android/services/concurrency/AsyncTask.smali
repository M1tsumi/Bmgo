...
.field private static final l:Lio/fabric/sdk/android/services/concurrency/AsyncTask$b;

.field private static volatile m:Ljava/util/concurrent/Executor;


# instance fields
.field private final n:Lio/fabric/sdk/android/services/concurrency/AsyncTask$d;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/fabric/sdk/android/services/concurrency/AsyncTask$d",
            "<TParams;TResult;>;"
...
.field private volatile p:Lio/fabric/sdk/android/services/concurrency/AsyncTask$Status;
...
.method static constructor <clinit>()V
    ...
    .line 204
    sget v0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->d:I
    ...
    sget v2, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->e:I
    ...
    sget-object v7, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->i:Ljava/util/concurrent/BlockingQueue;

    sget-object v8, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->h:Ljava/util/concurrent/ThreadFactory;
    ...
    sput-object v0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->l:Lio/fabric/sdk/android/services/concurrency/AsyncTask$b;

    .line 237
    sget-object v0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->c:Ljava/util/concurrent/Executor;

    sput-object v0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->m:Ljava/util/concurrent/Executor;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->p:Lio/fabric/sdk/android/services/concurrency/AsyncTask$Status;
    ...
    iput-object v0, p0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->q:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->r:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->n:Lio/fabric/sdk/android/services/concurrency/AsyncTask$d;

    .line 315
    new-instance v0, Lio/fabric/sdk/android/services/concurrency/AsyncTask$3;

    iget-object v1, p0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->n:Lio/fabric/sdk/android/services/concurrency/AsyncTask$d;
    ...
    iput-object v0, p0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->o:Ljava/util/concurrent/FutureTask;
...
.method static synthetic a(Lio/fabric/sdk/android/services/concurrency/AsyncTask;)Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .prologue
    .line 200
    iget-object v0, p0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->r:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(Ljava/lang/Runnable;)V
    ...
    .prologue
    .line 628
    sget-object v0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->m:Ljava/util/concurrent/Executor;
...
.method public static a(Ljava/util/concurrent/Executor;)V
    ...
    .prologue
    .line 298
    sput-object p0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->m:Ljava/util/concurrent/Executor;
...
.method private e(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 341
    sget-object v0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->l:Lio/fabric/sdk/android/services/concurrency/AsyncTask$b;
...
.method private f(Ljava/lang/Object;)V
    ...
    .prologue
    .line 653
    invoke-virtual {p0}, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->f()Z
...
.method public final varargs a(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Lio/fabric/sdk/android/services/concurrency/AsyncTask;
    ...
    .prologue
    .line 596
    iget-object v0, p0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->p:Lio/fabric/sdk/android/services/concurrency/AsyncTask$Status;
    ...
    iget-object v1, p0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->p:Lio/fabric/sdk/android/services/concurrency/AsyncTask$Status;
    ...
    .line 613
    iget-object v0, p0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->n:Lio/fabric/sdk/android/services/concurrency/AsyncTask$d;

    iput-object p2, v0, Lio/fabric/sdk/android/services/concurrency/AsyncTask$d;->b:[Ljava/lang/Object;

    .line 614
    iget-object v0, p0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->o:Ljava/util/concurrent/FutureTask;
...
.method public final a(Z)Z
    ...
    .prologue
    .line 490
    iget-object v0, p0, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->q:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method protected b(Ljava/lang/Object;)V
    ...
    .prologue
    .line 428
    invoke-virtual {p0}, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->i_()V
...
.method public final varargs c([Ljava/lang/Object;)Lio/fabric/sdk/android/services/concurrency/AsyncTask;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([TParams;)",
    ...
    invoke-virtual {p0, v0, p1}, Lio/fabric/sdk/android/services/concurrency/AsyncTask;->a(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Lio/fabric/sdk/android/services/concurrency/AsyncTask;
...
.method public final h_()Lio/fabric/sdk/android/services/concurrency/AsyncTask$Status;
    .locals 1
