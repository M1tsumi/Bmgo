...
.field static volatile c:Lio/fabric/sdk/android/Fabric;

.field static final d:Lio/fabric/sdk/android/k;
...
.field private final m:Lio/fabric/sdk/android/f;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/fabric/sdk/android/f",
            "<*>;"
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/fabric/sdk/android/Fabric;->d:Lio/fabric/sdk/android/k;

    return-void
.end method

.method constructor <init>(Landroid/content/Context;Ljava/util/Map;Lio/fabric/sdk/android/services/concurrency/j;Landroid/os/Handler;Lio/fabric/sdk/android/k;ZLio/fabric/sdk/android/f;Lio/fabric/sdk/android/services/common/IdManager;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object v0, p0, Lio/fabric/sdk/android/Fabric;->h:Landroid/content/Context;

    .line 285
    iput-object p2, p0, Lio/fabric/sdk/android/Fabric;->i:Ljava/util/Map;

    .line 286
    iput-object p3, p0, Lio/fabric/sdk/android/Fabric;->j:Ljava/util/concurrent/ExecutorService;

    .line 287
    iput-object p4, p0, Lio/fabric/sdk/android/Fabric;->k:Landroid/os/Handler;

    .line 288
    iput-object p5, p0, Lio/fabric/sdk/android/Fabric;->f:Lio/fabric/sdk/android/k;

    .line 289
    iput-boolean p6, p0, Lio/fabric/sdk/android/Fabric;->g:Z

    .line 290
    iput-object p7, p0, Lio/fabric/sdk/android/Fabric;->l:Lio/fabric/sdk/android/f;
    ...
    iput-object v0, p0, Lio/fabric/sdk/android/Fabric;->q:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {p0, v0}, Lio/fabric/sdk/android/Fabric;->createKitInitializationCallback(I)Lio/fabric/sdk/android/f;

    move-result-object v0

    iput-object v0, p0, Lio/fabric/sdk/android/Fabric;->m:Lio/fabric/sdk/android/f;

    .line 293
    iput-object p8, p0, Lio/fabric/sdk/android/Fabric;->n:Lio/fabric/sdk/android/services/common/IdManager;

    .line 294
    invoke-direct {p0, p1}, Lio/fabric/sdk/android/Fabric;->c(Landroid/content/Context;)Landroid/app/Activity;
...
.method static a()Lio/fabric/sdk/android/Fabric;
    ...
    .prologue
    .line 272
    sget-object v0, Lio/fabric/sdk/android/Fabric;->c:Lio/fabric/sdk/android/Fabric;
...
.method public static varargs a(Landroid/content/Context;[Lio/fabric/sdk/android/h;)Lio/fabric/sdk/android/Fabric;
    .locals 2
    ...
    invoke-virtual {v0, p1}, Lio/fabric/sdk/android/Fabric$Builder;->a([Lio/fabric/sdk/android/h;)Lio/fabric/sdk/android/Fabric$Builder;
    ...
    invoke-static {v0}, Lio/fabric/sdk/android/Fabric;->d(Lio/fabric/sdk/android/Fabric;)V
...
.method public static a(Ljava/lang/Class;)Lio/fabric/sdk/android/h;
    ...
    iget-object v0, v0, Lio/fabric/sdk/android/Fabric;->i:Ljava/util/Map;
...
.method static synthetic b(Lio/fabric/sdk/android/Fabric;)Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .prologue
    .line 48
    iget-object v0, p0, Lio/fabric/sdk/android/Fabric;->q:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method static synthetic c(Lio/fabric/sdk/android/Fabric;)Lio/fabric/sdk/android/f;
    .locals 1

    .prologue
    .line 48
    iget-object v0, p0, Lio/fabric/sdk/android/Fabric;->l:Lio/fabric/sdk/android/f;
...
.method private static d(Lio/fabric/sdk/android/Fabric;)V
    ...
    .prologue
    .line 340
    sput-object p0, Lio/fabric/sdk/android/Fabric;->c:Lio/fabric/sdk/android/Fabric;

    .line 341
    invoke-direct {p0}, Lio/fabric/sdk/android/Fabric;->n()V

    .line 342
    return-void
.end method

.method public static i()Lio/fabric/sdk/android/k;
    .locals 1
    ...
    .line 532
    sget-object v0, Lio/fabric/sdk/android/Fabric;->d:Lio/fabric/sdk/android/k;
    ...
    iget-object v0, v0, Lio/fabric/sdk/android/Fabric;->f:Lio/fabric/sdk/android/k;
...
.method public static j()Z
    ...
    iget-boolean v0, v0, Lio/fabric/sdk/android/Fabric;->g:Z
...
.method public static k()Z
    ...
    iget-object v0, v0, Lio/fabric/sdk/android/Fabric;->q:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private n()V
    ...
    iget-object v1, p0, Lio/fabric/sdk/android/Fabric;->h:Landroid/content/Context;

    invoke-direct {v0, v1}, Lio/fabric/sdk/android/a;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lio/fabric/sdk/android/Fabric;->o:Lio/fabric/sdk/android/a;

    .line 365
    iget-object v0, p0, Lio/fabric/sdk/android/Fabric;->o:Lio/fabric/sdk/android/a;
    ...
    .line 383
    iget-object v0, p0, Lio/fabric/sdk/android/Fabric;->h:Landroid/content/Context;
...
.method public a(Landroid/app/Activity;)Lio/fabric/sdk/android/Fabric;
    ...
    iput-object v0, p0, Lio/fabric/sdk/android/Fabric;->p:Ljava/lang/ref/WeakReference;
...
.method a(Landroid/content/Context;)V
    ...
    iget-object v1, p0, Lio/fabric/sdk/android/Fabric;->n:Lio/fabric/sdk/android/services/common/IdManager;

    invoke-virtual {v2, p1, p0, v0, v1}, Lio/fabric/sdk/android/l;->injectParameters(Landroid/content/Context;Lio/fabric/sdk/android/Fabric;Lio/fabric/sdk/android/f;Lio/fabric/sdk/android/services/common/IdManager;)V
    ...
    .line 415
    iget-object v4, p0, Lio/fabric/sdk/android/Fabric;->m:Lio/fabric/sdk/android/f;

    iget-object v5, p0, Lio/fabric/sdk/android/Fabric;->n:Lio/fabric/sdk/android/services/common/IdManager;

    invoke-virtual {v0, p1, p0, v4, v5}, Lio/fabric/sdk/android/h;->injectParameters(Landroid/content/Context;Lio/fabric/sdk/android/Fabric;Lio/fabric/sdk/android/f;Lio/fabric/sdk/android/services/common/IdManager;)V
    ...
    invoke-virtual {v4, v5}, Lio/fabric/sdk/android/g;->a(Lio/fabric/sdk/android/services/concurrency/k;)V

    .line 437
    iget-object v4, p0, Lio/fabric/sdk/android/Fabric;->i:Ljava/util/Map;

    invoke-virtual {p0, v4, v0}, Lio/fabric/sdk/android/Fabric;->a(Ljava/util/Map;Lio/fabric/sdk/android/h;)V
...
.method a(Ljava/util/Map;Lio/fabric/sdk/android/h;)V
    ...
    .prologue
    .line 460
    iget-object v0, p2, Lio/fabric/sdk/android/h;->dependsOnAnnotation:Lio/fabric/sdk/android/services/concurrency/c;

    .line 461
    if-eqz v0, :cond_4

    .line 462
    invoke-interface {v0}, Lio/fabric/sdk/android/services/concurrency/c;->a()[Ljava/lang/Class;
    ...
    invoke-virtual {v6, v0}, Lio/fabric/sdk/android/g;->a(Lio/fabric/sdk/android/services/concurrency/k;)V
    ...
    invoke-virtual {v5, v0}, Lio/fabric/sdk/android/g;->a(Lio/fabric/sdk/android/services/concurrency/k;)V
...
.method public b()Landroid/app/Activity;
    ...
    .prologue
    .line 357
    iget-object v0, p0, Lio/fabric/sdk/android/Fabric;->p:Ljava/lang/ref/WeakReference;
...
.method createKitInitializationCallback(I)Lio/fabric/sdk/android/f;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I)",
...
.method public f()Ljava/util/concurrent/ExecutorService;
    ...
    .prologue
    .line 500
    iget-object v0, p0, Lio/fabric/sdk/android/Fabric;->j:Ljava/util/concurrent/ExecutorService;
...
.method public g()Landroid/os/Handler;
    ...
    .prologue
    .line 504
    iget-object v0, p0, Lio/fabric/sdk/android/Fabric;->k:Landroid/os/Handler;
...
.method public h()Ljava/util/Collection;
    ...
    .prologue
    .line 511
    iget-object v0, p0, Lio/fabric/sdk/android/Fabric;->i:Ljava/util/Map;
...
.method public l()Ljava/lang/String;
    ...
    .prologue
    .line 558
    iget-object v0, p0, Lio/fabric/sdk/android/Fabric;->n:Lio/fabric/sdk/android/services/common/IdManager;
