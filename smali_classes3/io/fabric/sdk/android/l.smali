...
# static fields
.field static final a:Ljava/lang/String; = "com.crashlytics.ApiEndpoint"

.field private static final b:Ljava/lang/String; = "binary"


# instance fields
.field private final c:Lio/fabric/sdk/android/services/network/c;
...
.method public constructor <init>(Ljava/util/concurrent/Future;Ljava/util/Collection;)V
    ...
    iput-object v0, p0, Lio/fabric/sdk/android/l;->c:Lio/fabric/sdk/android/services/network/c;

    .line 63
    iput-object p1, p0, Lio/fabric/sdk/android/l;->l:Ljava/util/concurrent/Future;

    .line 64
    iput-object p2, p0, Lio/fabric/sdk/android/l;->m:Ljava/util/Collection;
...
.method private a(Lio/fabric/sdk/android/services/settings/o;Ljava/util/Collection;)Lio/fabric/sdk/android/services/settings/d;
    ...
    .line 213
    iget-object v0, p0, Lio/fabric/sdk/android/l;->i:Ljava/lang/String;
    ...
    iget-object v3, p0, Lio/fabric/sdk/android/l;->h:Ljava/lang/String;

    iget-object v4, p0, Lio/fabric/sdk/android/l;->g:Ljava/lang/String;

    iget-object v6, p0, Lio/fabric/sdk/android/l;->j:Ljava/lang/String;

    iget-object v8, p0, Lio/fabric/sdk/android/l;->k:Ljava/lang/String;
    ...
    invoke-direct/range {v0 .. v11}, Lio/fabric/sdk/android/services/settings/d;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Lio/fabric/sdk/android/services/settings/o;Ljava/util/Collection;)V
...
.method private a(Lio/fabric/sdk/android/services/settings/e;Lio/fabric/sdk/android/services/settings/o;Ljava/util/Collection;)Z
    ...
    .prologue
    .line 202
    invoke-direct {p0, p2, p3}, Lio/fabric/sdk/android/l;->a(Lio/fabric/sdk/android/services/settings/o;Ljava/util/Collection;)Lio/fabric/sdk/android/services/settings/d;

    move-result-object v0

    .line 203
    new-instance v1, Lio/fabric/sdk/android/services/settings/y;

    invoke-virtual {p0}, Lio/fabric/sdk/android/l;->b()Ljava/lang/String;

    move-result-object v2

    iget-object v3, p1, Lio/fabric/sdk/android/services/settings/e;->f:Ljava/lang/String;

    iget-object v4, p0, Lio/fabric/sdk/android/l;->c:Lio/fabric/sdk/android/services/network/c;

    invoke-direct {v1, p0, v2, v3, v4}, Lio/fabric/sdk/android/services/settings/y;-><init>(Lio/fabric/sdk/android/h;Ljava/lang/String;Ljava/lang/String;Lio/fabric/sdk/android/services/network/c;)V

    invoke-virtual {v1, v0}, Lio/fabric/sdk/android/services/settings/y;->a(Lio/fabric/sdk/android/services/settings/d;)Z
...
.method private a(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/e;Ljava/util/Collection;)Z
    ...
    iget-object v2, p2, Lio/fabric/sdk/android/services/settings/e;->e:Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lio/fabric/sdk/android/services/settings/r;->e()Z
    ...
    .line 170
    :cond_3
    iget-boolean v1, p2, Lio/fabric/sdk/android/services/settings/e;->h:Z
...
.method private b(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/e;Ljava/util/Collection;)Z
    ...
    invoke-direct {p0, v0, p3}, Lio/fabric/sdk/android/l;->a(Lio/fabric/sdk/android/services/settings/o;Ljava/util/Collection;)Lio/fabric/sdk/android/services/settings/d;

    move-result-object v0

    .line 185
    new-instance v1, Lio/fabric/sdk/android/services/settings/i;

    invoke-virtual {p0}, Lio/fabric/sdk/android/l;->b()Ljava/lang/String;

    move-result-object v2

    iget-object v3, p2, Lio/fabric/sdk/android/services/settings/e;->f:Ljava/lang/String;

    iget-object v4, p0, Lio/fabric/sdk/android/l;->c:Lio/fabric/sdk/android/services/network/c;

    invoke-direct {v1, p0, v2, v3, v4}, Lio/fabric/sdk/android/services/settings/i;-><init>(Lio/fabric/sdk/android/h;Ljava/lang/String;Ljava/lang/String;Lio/fabric/sdk/android/services/network/c;)V

    invoke-virtual {v1, v0}, Lio/fabric/sdk/android/services/settings/i;->a(Lio/fabric/sdk/android/services/settings/d;)Z
...
.method private c()Lio/fabric/sdk/android/services/settings/t;
    .locals 7
    ...
    iget-object v3, p0, Lio/fabric/sdk/android/l;->c:Lio/fabric/sdk/android/services/network/c;

    iget-object v4, p0, Lio/fabric/sdk/android/l;->g:Ljava/lang/String;

    iget-object v5, p0, Lio/fabric/sdk/android/l;->h:Ljava/lang/String;
    ...
    invoke-virtual/range {v0 .. v6}, Lio/fabric/sdk/android/services/settings/r;->a(Lio/fabric/sdk/android/h;Lio/fabric/sdk/android/services/common/IdManager;Lio/fabric/sdk/android/services/network/c;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lio/fabric/sdk/android/services/settings/r;

    move-result-object v0

    invoke-virtual {v0}, Lio/fabric/sdk/android/services/settings/r;->d()Z
...
.method private c(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/e;Ljava/util/Collection;)Z
    ...
    invoke-direct {p0, p2, v0, p3}, Lio/fabric/sdk/android/l;->a(Lio/fabric/sdk/android/services/settings/e;Lio/fabric/sdk/android/services/settings/o;Ljava/util/Collection;)Z
...
.method protected a()Ljava/lang/Boolean;
    ...
    .line 99
    invoke-direct {p0}, Lio/fabric/sdk/android/l;->c()Lio/fabric/sdk/android/services/settings/t;
    ...
    .line 104
    :try_start_0
    iget-object v0, p0, Lio/fabric/sdk/android/l;->l:Ljava/util/concurrent/Future;
    ...
    .line 111
    :goto_0
    iget-object v4, p0, Lio/fabric/sdk/android/l;->m:Ljava/util/Collection;
    ...
    .line 112
    iget-object v3, v3, Lio/fabric/sdk/android/services/settings/t;->a:Lio/fabric/sdk/android/services/settings/e;
...
.method protected onPreExecute()Z
    ...
    iput-object v1, p0, Lio/fabric/sdk/android/l;->d:Landroid/content/pm/PackageManager;
    ...
    .line 78
    iget-object v1, p0, Lio/fabric/sdk/android/l;->d:Landroid/content/pm/PackageManager;

    iget-object v2, p0, Lio/fabric/sdk/android/l;->e:Ljava/lang/String;
    ...
    iput-object v1, p0, Lio/fabric/sdk/android/l;->f:Landroid/content/pm/PackageInfo;

    .line 79
    iget-object v1, p0, Lio/fabric/sdk/android/l;->f:Landroid/content/pm/PackageInfo;
    ...
    iput-object v1, p0, Lio/fabric/sdk/android/l;->j:Ljava/lang/String;
