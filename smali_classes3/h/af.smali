...
.method static a(Landroid/transition/TransitionValues;)Lh/au;
    .locals 1
    ...
    .line 86
    invoke-static {p0, v0}, Lh/af;->a(Landroid/transition/TransitionValues;Lh/au;)V

    goto :goto_0
.end method

.method static a(Landroid/transition/TransitionValues;Lh/au;)V
    .locals 2
    ...
    iput-object v0, p1, Lh/au;->b:Landroid/view/View;
    ...
    .line 48
    iget-object v0, p1, Lh/au;->a:Ljava/util/Map;
...
.method static a(Lh/ad;Landroid/transition/TransitionValues;)V
    .locals 1
    ...
    .line 68
    invoke-interface {p0, v0}, Lh/ad;->a(Lh/au;)V

    .line 69
    invoke-static {v0, p1}, Lh/af;->a(Lh/au;Landroid/transition/TransitionValues;)V

    .line 70
    return-void
.end method

.method static a(Lh/au;Landroid/transition/TransitionValues;)V
    .locals 2
    ...
    .line 57
    :cond_1
    iget-object v0, p0, Lh/au;->b:Landroid/view/View;

    iput-object v0, p1, Landroid/transition/TransitionValues;->view:Landroid/view/View;

    .line 58
    iget-object v0, p0, Lh/au;->a:Ljava/util/Map;
    ...
    iget-object v1, p0, Lh/au;->a:Ljava/util/Map;
...
.method static b(Lh/ad;Landroid/transition/TransitionValues;)V
    .locals 1
    ...
    .line 77
    invoke-interface {p0, v0}, Lh/ad;->b(Lh/au;)V
...
.method static d(Lh/au;)Landroid/transition/TransitionValues;
    .locals 1
    ...
    .line 96
    invoke-static {p0, v0}, Lh/af;->a(Lh/au;Landroid/transition/TransitionValues;)V
...
.method public a()J
    ...
    .prologue
    .line 221
    iget-object v0, p0, Lh/af;->a:Landroid/transition/Transition;
...
.method public a(Landroid/view/ViewGroup;Lh/au;Lh/au;)Landroid/animation/Animator;
    ...
    .line 170
    invoke-static {p2, v1}, Lh/af;->a(Lh/au;Landroid/transition/TransitionValues;)V
    ...
    .line 176
    invoke-static {p3, v0}, Lh/af;->a(Lh/au;Landroid/transition/TransitionValues;)V

    .line 180
    :cond_0
    iget-object v2, p0, Lh/af;->a:Landroid/transition/Transition;
...
.method public a(I)Lh/ac;
    ...
    .line 290
    invoke-virtual {p0}, Lh/af;->e()Ljava/util/List;
...
.method public a(Lh/ae;)Lh/ac;
    ...
    .prologue
    .line 112
    iget-object v0, p0, Lh/af;->c:Lh/af$a;

    if-nez v0, :cond_0

    .line 113
    new-instance v0, Lh/af$a;

    invoke-direct {v0, p0}, Lh/af$a;-><init>(Lh/af;)V

    iput-object v0, p0, Lh/af;->c:Lh/af$a;

    .line 114
    iget-object v0, p0, Lh/af;->a:Landroid/transition/Transition;

    iget-object v1, p0, Lh/af;->c:Lh/af$a;
    ...
    invoke-virtual {v0, p1}, Lh/af$a;->a(Lh/ae;)V
...
.method public a(Lh/ad;Ljava/lang/Object;)V
    ...
    .prologue
    .line 102
    iput-object p1, p0, Lh/af;->b:Lh/ad;

    .line 103
    if-nez p2, :cond_0

    .line 104
    new-instance v0, Lh/af$b;

    invoke-direct {v0, p1}, Lh/af$b;-><init>(Lh/ad;)V

    iput-object v0, p0, Lh/af;->a:Landroid/transition/Transition;
    ...
    iput-object p2, p0, Lh/af;->a:Landroid/transition/Transition;
...
.method public b(Lh/ae;)Lh/ac;
    ...
    invoke-virtual {v0, p1}, Lh/af$a;->b(Lh/ae;)V

    .line 126
    iget-object v0, p0, Lh/af;->c:Lh/af$a;

    invoke-virtual {v0}, Lh/af$a;->a()Z
...
.method public b(Lh/au;)V
    ...
    .line 149
    invoke-static {p1, v0}, Lh/af;->a(Lh/au;Landroid/transition/TransitionValues;)V

    .line 150
    iget-object v1, p0, Lh/af;->a:Landroid/transition/Transition;

    invoke-virtual {v1, v0}, Landroid/transition/Transition;->captureEndValues(Landroid/transition/TransitionValues;)V

    .line 151
    invoke-static {v0, p1}, Lh/af;->a(Landroid/transition/TransitionValues;Lh/au;)V
...
.method public c(Landroid/view/View;Z)Lh/au;
    ...
    invoke-static {v1, v0}, Lh/af;->a(Landroid/transition/TransitionValues;Lh/au;)V
