...
.method static synthetic a(Lz/b;)Lcom/google/android/exoplayer2/util/f;
    .locals 1

    .prologue
    .line 33
    iget-object v0, p0, Lz/b;->d:Lcom/google/android/exoplayer2/util/f;
...
.method private c(Lcom/google/android/exoplayer2/util/m;)I
    ...
    .line 108
    invoke-virtual {p1}, Lcom/google/android/exoplayer2/util/m;->C()J
...
.method protected a(Z)V
    ...
    .line 52
    iput-object v0, p0, Lz/b;->d:Lcom/google/android/exoplayer2/util/f;

    .line 53
    iput-object v0, p0, Lz/b;->e:Lz/b$a;
...
.method protected a(Lcom/google/android/exoplayer2/util/m;JLz/h$a;)Z
    ...
    .line 73
    iget-object v4, p0, Lz/b;->d:Lcom/google/android/exoplayer2/util/f;

    if-nez v4, :cond_2

    .line 74
    new-instance v4, Lcom/google/android/exoplayer2/util/f;

    const/16 v5, 0x11

    invoke-direct {v4, v3, v5}, Lcom/google/android/exoplayer2/util/f;-><init>([BI)V

    iput-object v4, p0, Lz/b;->d:Lcom/google/android/exoplayer2/util/f;
    ...
    .line 79
    invoke-virtual {v4}, Lcom/google/android/exoplayer2/util/f;->b()I

    move-result v6

    iget-object v4, p0, Lz/b;->d:Lcom/google/android/exoplayer2/util/f;

    iget v7, v4, Lcom/google/android/exoplayer2/util/f;->f:I

    iget-object v4, p0, Lz/b;->d:Lcom/google/android/exoplayer2/util/f;

    iget v8, v4, Lcom/google/android/exoplayer2/util/f;->e:I
    ...
    iput-object v2, v0, Lz/h$a;->a:Lcom/google/android/exoplayer2/Format;
    ...
    invoke-direct {v3, p0, v2}, Lz/b$a;-><init>(Lz/b;Lz/b$1;)V

    iput-object v3, p0, Lz/b;->e:Lz/b$a;

    .line 83
    iget-object v2, p0, Lz/b;->e:Lz/b$a;

    invoke-virtual {v2, p1}, Lz/b$a;->a(Lcom/google/android/exoplayer2/util/m;)V

    goto :goto_0

    .line 84
    :cond_3
    invoke-static {v3}, Lz/b;->a([B)Z
    ...
    invoke-virtual {v2, v0, v1}, Lz/b$a;->a(J)V
    ...
    iput-object v2, v0, Lz/h$a;->b:Lz/f;
...
.method protected b(Lcom/google/android/exoplayer2/util/m;)J
    ...
    :cond_0
    invoke-direct {p0, p1}, Lz/b;->c(Lcom/google/android/exoplayer2/util/m;)I
