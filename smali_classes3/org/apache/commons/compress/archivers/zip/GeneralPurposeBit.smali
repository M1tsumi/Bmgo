...
.method public static parse([BI)Lorg/apache/commons/compress/archivers/zip/GeneralPurposeBit;
    ...
    .line 206
    new-instance v4, Lorg/apache/commons/compress/archivers/zip/GeneralPurposeBit;

    invoke-direct {v4}, Lorg/apache/commons/compress/archivers/zip/GeneralPurposeBit;-><init>()V
    ...
    :goto_0
    invoke-virtual {v4, v0}, Lorg/apache/commons/compress/archivers/zip/GeneralPurposeBit;->useDataDescriptor(Z)V
    ...
    :goto_1
    invoke-virtual {v4, v0}, Lorg/apache/commons/compress/archivers/zip/GeneralPurposeBit;->useUTF8ForNames(Z)V
    ...
    :goto_2
    invoke-virtual {v4, v0}, Lorg/apache/commons/compress/archivers/zip/GeneralPurposeBit;->useStrongEncryption(Z)V
    ...
    :goto_3
    invoke-virtual {v4, v1}, Lorg/apache/commons/compress/archivers/zip/GeneralPurposeBit;->useEncryption(Z)V
    ...
    :goto_4
    iput v0, v4, Lorg/apache/commons/compress/archivers/zip/GeneralPurposeBit;->slidingDictionarySize:I
    ...
    :goto_5
    iput v0, v4, Lorg/apache/commons/compress/archivers/zip/GeneralPurposeBit;->numberOfShannonFanoTrees:I
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 226
    instance-of v1, p1, Lorg/apache/commons/compress/archivers/zip/GeneralPurposeBit;
    ...
    .line 230
    iget-boolean v1, p1, Lorg/apache/commons/compress/archivers/zip/GeneralPurposeBit;->encryptionFlag:Z

    iget-boolean v2, p0, Lorg/apache/commons/compress/archivers/zip/GeneralPurposeBit;->encryptionFlag:Z

    if-ne v1, v2, :cond_0

    iget-boolean v1, p1, Lorg/apache/commons/compress/archivers/zip/GeneralPurposeBit;->strongEncryptionFlag:Z

    iget-boolean v2, p0, Lorg/apache/commons/compress/archivers/zip/GeneralPurposeBit;->strongEncryptionFlag:Z

    if-ne v1, v2, :cond_0

    iget-boolean v1, p1, Lorg/apache/commons/compress/archivers/zip/GeneralPurposeBit;->languageEncodingFlag:Z

    iget-boolean v2, p0, Lorg/apache/commons/compress/archivers/zip/GeneralPurposeBit;->languageEncodingFlag:Z

    if-ne v1, v2, :cond_0

    iget-boolean v1, p1, Lorg/apache/commons/compress/archivers/zip/GeneralPurposeBit;->dataDescriptorFlag:Z

    iget-boolean v2, p0, Lorg/apache/commons/compress/archivers/zip/GeneralPurposeBit;->dataDescriptorFlag:Z
