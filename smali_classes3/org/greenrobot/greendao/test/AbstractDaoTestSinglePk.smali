...
.method protected queryWithDummyColumnsInFront(ILjava/lang/String;Ljava/lang/Object;)Landroid/database/Cursor;
    ...
    invoke-static {v2, v1, v3}, Lorg/greenrobot/greendao/internal/SqlUtils;->appendColumns(Ljava/lang/StringBuilder;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-virtual {v1}, Lorg/greenrobot/greendao/AbstractDao;->getPkColumns()[Ljava/lang/String;

    move-result-object v1

    array-length v1, v1

    invoke-static {v5, v1}, Lorg/greenrobot/greendao/test/AbstractDaoTestSinglePk;->assertEquals(II)V
    ...
    .line 324
    iget-object v2, p0, Lorg/greenrobot/greendao/test/AbstractDaoTestSinglePk;->db:Lorg/greenrobot/greendao/database/Database;

    const/4 v3, 0x0

    invoke-interface {v2, v1, v3}, Lorg/greenrobot/greendao/database/Database;->rawQuery(Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-static {v2}, Lorg/greenrobot/greendao/test/AbstractDaoTestSinglePk;->assertTrue(Z)V
    ...
    invoke-static {p2, v2}, Lorg/greenrobot/greendao/test/AbstractDaoTestSinglePk;->assertEquals(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v2}, Lorg/greenrobot/greendao/test/AbstractDaoTestSinglePk;->assertEquals(II)V
    :try_end_0
...
.method public testDeleteByKeyInTx()V
    ...
    invoke-virtual {v0, v2}, Lorg/greenrobot/greendao/AbstractDao;->insertInTx(Ljava/lang/Iterable;)V
    ...
    invoke-virtual {v1, v0}, Lorg/greenrobot/greendao/AbstractDao;->deleteByKeyInTx(Ljava/lang/Iterable;)V
...
.method public testInsertOrReplaceInTx()V
    ...
    invoke-virtual {v0, v2}, Lorg/greenrobot/greendao/AbstractDao;->insertOrReplaceInTx(Ljava/lang/Iterable;)V
...
.method public testInsertOrReplaceTwice()V
    ...
    invoke-virtual {v4}, Lorg/greenrobot/greendao/AbstractDao;->getPkProperty()Lorg/greenrobot/greendao/Property;

    move-result-object v4

    iget-object v4, v4, Lorg/greenrobot/greendao/Property;->type:Ljava/lang/Class;
...
.method public testLoadAll()V
    ...
    invoke-static {v1, v0}, Lorg/greenrobot/greendao/test/AbstractDaoTestSinglePk;->assertEquals(II)V
...
.method public testQuery()V
    ...
    invoke-virtual {v2, v1, v3}, Lorg/greenrobot/greendao/AbstractDao;->queryRaw(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {v6, v2}, Lorg/greenrobot/greendao/test/AbstractDaoTestSinglePk;->assertEquals(II)V
...
.method public testReadWithOffset()V
    ...
    invoke-virtual {p0, v3, v1, v0}, Lorg/greenrobot/greendao/test/AbstractDaoTestSinglePk;->queryWithDummyColumnsInFront(ILjava/lang/String;Ljava/lang/Object;)Landroid/database/Cursor;
    ...
    invoke-virtual {v2, v1, v3}, Lorg/greenrobot/greendao/InternalUnitTestDaoAccess;->readEntity(Landroid/database/Cursor;I)Ljava/lang/Object;
...
.method public testSaveInTx()V
    ...
    invoke-virtual {v0, v2}, Lorg/greenrobot/greendao/AbstractDao;->saveInTx(Ljava/lang/Iterable;)V
