...
.method static constructor <clinit>()V
    ...
    invoke-direct {v2, v4, v5, v3, v6}, Lorg/mozilla/javascript/v8dtoa/CachedPowers$CachedPower;-><init>(JSS)V
    ...
    const-wide v4, -0x7dc3ed86a24931a9L    # -6.706874809979197E-298

    const/16 v3, -0x34f

    invoke-direct {v2, v4, v5, v3, v8}, Lorg/mozilla/javascript/v8dtoa/CachedPowers$CachedPower;-><init>(JSS)V
    ...
    const-wide v4, -0x66c01d392f848054L    # -4.580160027317821E-187

    const/16 v3, -0x34

    invoke-direct {v2, v4, v5, v8, v3}, Lorg/mozilla/javascript/v8dtoa/CachedPowers$CachedPower;-><init>(JSS)V
    ...
    const-wide/high16 v4, -0x63c0000000000000L

    const/16 v3, -0x32

    invoke-direct {v2, v4, v5, v3, v10}, Lorg/mozilla/javascript/v8dtoa/CachedPowers$CachedPower;-><init>(JSS)V
    ...
    const-wide v4, -0x172b5af000000000L    # -9.645113526668761E196
    ...
    const-wide v4, -0x5287143a539e0000L    # -1.2233944464302153E-89

    const/16 v3, 0x14

    invoke-direct {v2, v4, v5, v9, v3}, Lorg/mozilla/javascript/v8dtoa/CachedPowers$CachedPower;-><init>(JSS)V
    ...
    const-wide v4, -0x7ec0c687076bf67cL
    ...
    const-wide v4, -0x3f68318436f8ea4dL    # -1523.6208840472216
    ...
    const-wide v4, -0x2a2dc75b54167f98L    # -2.611902547306385E105
    ...
    const-wide v4, -0x60b0d8d9e865ddbbL    # -7.090732707359209E-158
    ...
    const-wide v4, -0x4f219ac773375258L
...
.method static getCachedPower(IIILorg/mozilla/javascript/v8dtoa/DiyFp;)I
    ...
    iget-wide v2, v0, Lorg/mozilla/javascript/v8dtoa/CachedPowers$CachedPower;->significand:J

    invoke-virtual {p3, v2, v3}, Lorg/mozilla/javascript/v8dtoa/DiyFp;->setF(J)V
