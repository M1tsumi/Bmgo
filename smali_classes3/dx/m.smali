...
.field private e:Lio/fabric/sdk/android/services/common/n;
...
.method public constructor <init>(Landroid/content/Context;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 52
    iput-object p1, p0, Ldx/m;->a:Landroid/content/Context;

    .line 53
    iput-object p2, p0, Ldx/m;->b:Ljava/io/File;

    .line 54
    iput-object p4, p0, Ldx/m;->c:Ljava/lang/String;

    .line 56
    new-instance v0, Ljava/io/File;

    iget-object v1, p0, Ldx/m;->b:Ljava/io/File;

    invoke-direct {v0, v1, p3}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    iput-object v0, p0, Ldx/m;->d:Ljava/io/File;

    .line 58
    new-instance v0, Lio/fabric/sdk/android/services/common/n;

    iget-object v1, p0, Ldx/m;->d:Ljava/io/File;

    invoke-direct {v0, v1}, Lio/fabric/sdk/android/services/common/n;-><init>(Ljava/io/File;)V

    iput-object v0, p0, Ldx/m;->e:Lio/fabric/sdk/android/services/common/n;

    .line 60
    invoke-direct {p0}, Ldx/m;->g()V
...
.method private a(Ljava/io/File;Ljava/io/File;)V
    ...
    .line 105
    :try_start_1
    invoke-virtual {p0, p2}, Ldx/m;->a(Ljava/io/File;)Ljava/io/OutputStream;
...
.method private g()V
    ...
    iget-object v2, p0, Ldx/m;->c:Ljava/lang/String;

    invoke-direct {v0, v1, v2}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    iput-object v0, p0, Ldx/m;->f:Ljava/io/File;

    .line 65
    iget-object v0, p0, Ldx/m;->f:Ljava/io/File;
...
.method public a()I
    ...
    .prologue
    .line 77
    iget-object v0, p0, Ldx/m;->e:Lio/fabric/sdk/android/services/common/n;
...
.method public a(Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lio/fabric/sdk/android/services/common/n;->close()V

    .line 84
    iget-object v0, p0, Ldx/m;->d:Ljava/io/File;

    new-instance v1, Ljava/io/File;

    iget-object v2, p0, Ldx/m;->f:Ljava/io/File;

    invoke-direct {v1, v2, p1}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    invoke-direct {p0, v0, v1}, Ldx/m;->a(Ljava/io/File;Ljava/io/File;)V
...
.method public a(Ljava/util/List;)V
    ...
    .line 151
    iget-object v2, p0, Ldx/m;->a:Landroid/content/Context;
...
.method public a([B)V
    ...
    invoke-virtual {v0, p1}, Lio/fabric/sdk/android/services/common/n;->a([B)V
...
.method public a(II)Z
    ...
    invoke-virtual {v0, p1, p2}, Lio/fabric/sdk/android/services/common/n;->a(II)Z
...
.method public c()Ljava/io/File;
    ...
    .prologue
    .line 125
    iget-object v0, p0, Ldx/m;->b:Ljava/io/File;
